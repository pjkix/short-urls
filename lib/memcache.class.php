 ...
 * @author		PJ Khalil <pj@pjkix.com>
 * @copyright	2007 Podshow, Inc.
 * @license 	http://podshow.com
 * @version	 $Id:$
 */
...
class cacheMemcache
{
	...
	static function get($key)
	{
		...
		{
			trigger_error('cacheMemcache::get() attempted with no connection present',E_USER_ERROR);
	...
	static function replace($key,$value,$compress = False, $ttl = NULL)
	{
		if (self::$memcache === NULL)
		{
			trigger_error('cacheMemcache::replace() attempted with no connection present',E_USER_ERROR);
	...
	static function add($key,$value,$compress = False, $ttl = NULL)
	{
		if (self::$memcache === NULL)
		{
			trigger_error('cacheMemcache::add() attempted with no connection present',E_USER_ERROR);
	...
	static function delete($key,$seconds_till_delete = NULL)
	{
		if (self::$memcache === NULL)
		{
			trigger_error('cacheMemcache::delete() attempted with no connection present',E_USER_ERROR);
	...
	static function increment($key,$value = 1)
	{
		if (self::$memcache === NULL)
		{
			trigger_error('cacheMemcache::increment() attempted with no connection present',E_USER_ERROR);
	...
	static function decrement($key,$value = 1)
	{
		if (self::$memcache === NULL)
		{
			trigger_error('cacheMemcache::decrement() attempted with no connection present',E_USER_ERROR);
	...
	static function flush()
	{
		if (self::$memcache === NULL)
		{
			trigger_error('cacheMemcache::flush() attempted with no connection present',E_USER_ERROR);
